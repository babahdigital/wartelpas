      ...
      <div class="row">
        <div class="col-6">
          <div class="card" style="border:1px solid #2c3e50;">
            ...
            <div class="card-body">
              <textarea id="onlogin-output" class="form-control" rows="12" readonly><?php echo htmlspecialchars($script_onlogin); ?></textarea>
            </div>
          </div>
        </div>
        <div class="col-6">
          <div class="card" style="border:1px solid #2c3e50;">
            ...
            <div class="card-body">
              <textarea id="onlogout-output" class="form-control" rows="12" readonly><?php echo htmlspecialchars($script_onlogout); ?></textarea>
            </div>
          </div>
        </div>
      </div>
