        ...
        <td class="text-center">
          ...
          <?php if (in_array($req_status, ['all','ready','used','rusak','online','retur'], true)): ?>
            <?php if ($is_used && in_array($req_status, ['all','used'], true)): ?>
              <button type="button" class="btn-act btn-act-print" onclick="window.open('./report/print_rincian.php?mode=usage&status=rusak&user=<?= urlencode($u['name']) ?>&session=<?= $session ?>','_blank').print()" title="Print Rincian (Template Rusak)"><i class="fa fa-print"></i></button>
...
?>
  ...
  <style>
    ...
    .confirm-btn i.fa.fa-print.dul { margin-top:3px; position: relative; margin-right: 8px; }
