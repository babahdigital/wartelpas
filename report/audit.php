    ...
    <div class="modal-card">
        ...
        <form method="post" action="?report=audit_session&session=<?= urlencode($session_id) ?>&show=<?= urlencode($req_show) ?>&date=<?= urlencode($filter_date) ?>">
            ...
            <div class="modal-body">
                ...
                <textarea name="note_text" rows="5" class="form-input" maxlength="500" placeholder="Tulis keterangan di sini..." style="width: 100%; max-width: 465px; margin-top: 10px;"><?= htmlspecialchars($daily_note_alert) ?></textarea>
